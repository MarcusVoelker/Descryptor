...
import descryptor.common.exceptionHandler.exceptions.RecursionException;
...
import descryptor.jworldgen.parser.parseStructure.ParseSubArea;
...
public class TreeNodeArea {
	...
	public void setParseAssignments(ArrayList<ParseAssignment> assignments)
	{
		if (assignments == null)
		...
		else 
		{
			...
			{
				this.assignments.add(pa.toAssignment());
			}
		}
	}
	...
	public void setAssignments(ArrayList<Assignment> assignments)
	{
		if (assignments == null)
			...
			this.assignments = (ArrayList<Assignment>) assignments.clone();
	}
	...
	public void addSubArea(TreeNodeArea area) throws CriticalFailure
	{
		...
		for (ParseSubArea parseSubArea : parseSubAreas)
		{
			...
			{
				area.setParseAssignments(parseSubArea.assignments);
			}
		}
	}
