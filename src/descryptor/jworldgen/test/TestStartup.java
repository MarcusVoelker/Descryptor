package descryptor.jworldgen.test;
...
import descryptor.jworldgen.filehandler.WorldSaver;
import descryptor.jworldgen.generator.Generator;
...
public class TestStartup {
	...
	private static void load()
	{
		try {
			...
			String input = TextFileReader.readTextFile("data/WorleyRules.txt");
			Generator gen = new Generator();
			gen.initialize(seed,new Object[]{input});
			world = (World) gen.generateFully(new Object[]{50,50,50});
	...
	private static void render3D()
	{
		...
		{
			try {
				WorldSaver.saveWorld(world, "worlds/SavedWorld.jwd");
			} catch (CriticalFailure e) {
				e.printStackTrace();
			}
		}
